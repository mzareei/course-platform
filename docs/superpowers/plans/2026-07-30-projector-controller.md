...
**Files:**
- Create: backend `supabase/migrations/0028_class_presentation_state.sql`
...
git add supabase/migrations/0028_class_presentation_state.sql tools/verify-projector-safety.mjs
...
- [ ] **Step 2: Apply migration 0028 and deploy**
