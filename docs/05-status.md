...
**Shipped 2026-08-26**, both repos together, in the order under "Deploy shape"
below. It did not ship that way the first time, and that cost a class: the three
edge functions were deployed from this branch on 2026-08-24 at 19:20 while the
frontend stayed on `main`, and the 2026-08-26 lecture met the result — live
questions never reached a phone, the quiz could not be submitted, and the race
screen sat frozen. See the 2026-08-26 outage entry above and pitfall #94.
